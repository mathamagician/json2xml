...
export const tools: ToolMeta[] = [
  // ─── Converters ──────────────────────────────────────────────────
  {
    ...
    navTitle: "JSON → XML",
    description: "Convert JSON to XML instantly in your browser. Free, private, handles files up to 2 GB.",
    category: "converters",
  ...
  },
  {
    ...
    navTitle: "XML → JSON",
    description: "Convert XML to JSON instantly in your browser. Free, private, handles files up to 2 GB.",
    category: "converters",
