...
export const metadata: Metadata = {
  ...
  description:
    "Convert XML to JSON instantly in your browser. Handles files up to 500 MB. Free, private, no sign-up — your data never leaves your machine.",
  keywords: [
    "xml to json",
  ...
  openGraph: {
    title: "Free XML to JSON Converter Online — json2xml.com",
    description:
      "Convert XML to JSON instantly in your browser. Handles files up to 500 MB. Free, private, no sign-up required.",
...
const jsonLd = {
  ...
  url: "https://json2xml.com/xml-to-json",
  description:
    "Free online tool to convert XML to JSON instantly in your browser. Handles files up to 500 MB. No sign-up, no uploads — 100% private.",
      ...
      <section className="bg-slate-900 border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 py-8 text-center">
          ...
          <p className="text-slate-400 max-w-xl mx-auto">
            Paste, upload, or drag &amp; drop XML files up to 500 MB. Converts instantly in your
            browser —{" "}
      ...
      <section className="border-t border-slate-800 bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 py-12 grid sm:grid-cols-3 gap-8 text-sm text-slate-400">
          ...
          <div>
            ...
            <p>
              Drag and drop <code className="text-slate-300">.xml</code> files up to 500 MB.
